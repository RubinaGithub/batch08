  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <?php $__currentLoopData = $data['temp_orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp_order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        <form id="update_cart" method="post" action="<?php echo e(url('/')); ?>/update-cart"id="<?php echo e($temp_order->temp_order_row_id); ?>">
        <?php echo e(csrf_field()); ?>     
        <tr id="tid_<?php echo e($temp_order->temp_order_row_id); ?>">
          ...
          <td> 
            <a href="javascript:void(0)" temp_order_row_id="<?php echo e($temp_order->temp_order_row_id); ?>" class="btn btn-danger remove-item" data-toggle="modal" data-target="#confirm" />Delete
            </a>
            <input type="hidden" name="temp_order_row_id[]" value="<?php echo e($temp_order->temp_order_row_id); ?>" /> 
           </td>
        </tr>
      ...
      <tr>
        <td colspan="2" class="text-right">
         ...
         <td class="text-left">  $<?php echo e($data['total_price']); ?></td>
         <td>&nbsp;</td>
      </tr> 
 ...
 $("#qty_textbox").change(function(){ 
  ...
  $('#delete-btn').click( function() {
    $('#confirm').modal('toggle');
      var temp_order_row_id = $(this).attr('temp_order_row_id');
      $.ajax({
          url: "<?php echo e(url('cartItemDelete/')); ?>"+'/'+ temp_order_row_id,
          type: "GET",
          dataType: "html",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_new\resources\views/cart.blade.php ENDPATH**/ ?>