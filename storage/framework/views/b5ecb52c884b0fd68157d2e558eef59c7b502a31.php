<?php $__env->startSection('content'); ?>
        ...
        <div class="card">
          ...
          <div class="card-body"  style="text-align: center;">
            <span class='zoom' id='ex1'>
              <img class="zoom-img" src="<?php echo e(asset('images/product_image/'.$data->product_image)); ?>"  width='600' height='320' alt="SHOW IMAGE HERE" style="max-width:325px">
            </span>
          </div>
          <div class="card-footer">
            <small class="text-muted"><strong>Price: <?php echo e($data->product_price); ?></strong></small>
          </div>
        </div>
      </div>    
        ...
        <div class="tabs">
          ...
          <div id="tab02" class="tab-contents">
            ...
            <div id="reviews" class="woocommerce-Reviews">
              <div id="comments">
                <?php if(!$product_ratings->isEmpty()): ?>

                  <?php $__currentLoopData = $product_ratings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="panel panel-default arrow left">
                        <div class="panel-body">
                          <header class="text-left">
                            <div class="comment-user"><i class="fa fa-user"></i> <?php echo e($rating->name); ?></div>
                            <time class="comment-date" datetime="16-12-2014 01:05"><i class="fa fa-clock-o"></i>
                              <?php echo e(date('d-M-Y', strtotime($rating->created_at))); ?>

                            </time>
                          </header>
                          <div class="comment-post">
                            <p><?php echo e($rating->reviews); ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div style="clear: both;">
                        ...
                        <p class="comment-form-author">
                          ...
                          <p class="form-submit">
                            ...
                            <input type="hidden" name="product_id" value="<?php echo e($data->product_row_id); ?>" id="product_id">
  ...
  <script>
    ...
    $( "#submitreview" ).on( "click", function( event ) {
        ...
        $.ajax({
           type: 'POST',
           url: "<?php echo e(url('product/submitRating')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_new\resources\views/product_detail.blade.php ENDPATH**/ ?>