...
<head>
  ...
  <link href="{{ asset('/css/admin/fontawesome-free/all.min.css') }}" rel="stylesheet" type="text/css">
  ...
  <!-- Page level custom scripts -->
  <script src="{{ asset('/js/admin/datatables/datatables-demo.js') }}"></script>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ url('/') }}">add/edit product</a>
          </div>
        </div>
      </li>
