        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="{{ url('/')}}/product/{{ $data->product_row_id}}"><img class="card-img-top" src="{{asset('images/product_image/'.$data->product_image)}}" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="{{ url('/')}}/product/{{ $data->product_row_id}}">{{ $data->product_name}}</a>
                </h4>
